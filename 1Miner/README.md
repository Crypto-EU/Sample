...
- Cache: `/tmp/1miner-autotune-1.0.22.json`
...
- **Installation URL:**  
  `https://raw.githubusercontent.com/Crypto-EU/Sample/cursor/1miner-amd-hiveos-3705/1Miner/releases/1miner-hive-1.0.22.tar.gz`  
- **Extra config:** `--autotune-force`

## Hinweis

1Miner v1.0.22: GPU-only (no host/CPU re-hash or CPU mining); hasher-style u32 loop + autotune ~3.4 GH/s.
